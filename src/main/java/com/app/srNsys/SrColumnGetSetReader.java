 ...
 * @author Sunghalee
 */
public class SrColumnGetSetReader extends JFrame {
    ...
    private static JTextField mapperField;
    ...
    public static void action() {
        ...
        inputPanel.add(new JLabel("model对象："));
        inputPanel.add(modelField);
        inputPanel.add(new JLabel("mapper对象："));
        inputPanel.add(mapperField);
...
//        });
    ...
    private static JButton getjButton() {
        ...
        startButton.addActionListener(e -> {
            ...
            String mapperName = mapperField.getText();
            ...
            if (sheetName.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(frame, "请输入model名", "警告", JOptionPane.WARNING_MESSAGE);
            } else if (mapperName.isEmpty()) {
                JOptionPane.showMessageDialog(frame, "请输入mapper名", "警告", JOptionPane.WARNING_MESSAGE);
            } else {
                    ...
                    if (row != null) {
                        ...
                        if (cellItem != null && cellType != null && cellModelName != null &&
                            ...
                            if ((valueType.equals("TXTS") || valueType.equals("LIST"))) {
                                ...
                                outputText.append(modelName);
                                outputText.append(".set");
                                outputText.append(extractAndFormatFieldName(valueModelName));
                                outputText.append("(");
                                outputText.append(mapperName);
                                outputText.append(".get");
                                outputText.append(extractAndFormatFieldName(valueModelName));
                                outputText.append("());\n");
